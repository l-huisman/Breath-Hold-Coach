          ...
          >
            ...
            <View style={styles.section}>
              ...
              <TextInput
                ...
                accessibilityHint="Voer geboortedatum in als DD-MM-JJJJ"
                editable={!isSaving}
              />
            ...
            <View style={styles.section}>
              ...
              <OptionButton
                ...
                description="De app begeleidt je in kleinere stappen met extra oefenmomenten."
...
// Helper function to mask patient number for privacy (show last 3 digits)
function maskPatientNumber(patientNumber: string): string {
  if (patientNumber.length <= 3) {
    return patientNumber;
  }
  const lastThree = patientNumber.slice(-3);
  const masked = '*'.repeat(patientNumber.length - 3);
